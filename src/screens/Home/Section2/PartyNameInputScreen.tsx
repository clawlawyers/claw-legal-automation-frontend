// src/screens/Home/Section2/PartyNameInputScreen.tsx
...
const PartyNameInputScreen = (props : PartyNameInputScreenNavigationProp) => {
  ...
  const handleFetchCase = () => {
    ...
    if (!partyName.trim()) {
        Toast.show({type: 'error', text1: 'Input Required', text2: 'Please enter a Party Name.'});
        return;
    }
    
    console.log(`Fetching case for Party Name: ${partyName}`);
    console.log('With saved court details:', selectedCourt);
     navigation.navigate('CaseLoadingScreen', { fromScreen: 'PartyNameInputScreen' });
        ...
        <KeyboardAvoidingView style={{flex: 1}} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          <View style={styles.innerContainer}>
            <ScrollView contentContainerStyle={styles.scrollContentContainer} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.titleText}>Search Using Party Name</Text>
              <Text style={styles.instructionText}>
                Enter Valid Party Name To Fetch Your Case And Add To Your Cases
              </Text>
...
export default PartyNameInputScreen;